  ...
  <div
    ...
    <NuxtLink :to="`/item/${product.id}`">
      ...
      <div id="ProductDetails">
        <span class="block text-[#252525] text-sm font-semibold mt-1 pl-1">{{
          product.title
        }}</span>

        <span class="flex items-center gap-3 pl-1">
          <span class="text-[#FF6674] font-semibold">{{ priceComputed }}đ</span>
          <span class="text-gray-500 text-sm line-through"
            >{{ oldPriceComputed }}đ</span
          >
        </span>
