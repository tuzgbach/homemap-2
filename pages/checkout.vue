      ...
      <div class="md:flex gap-4 justify-between mx-auto w-full">
        <div class="md:w-[65%]">
          <div class="bg-white rounded-lg p-4">
            <div class="text-xl font-semibold mb-2">Địa chỉ giao hàng</div>
            ...
            <div v-if="currentAddress && currentAddress.data">
              ...
              <div class="pt-2 border-t">
                <div class="underline pb-1">Địa chỉ giao hàng</div>
                <ul class="text-xs">
        ...
        <div class="md:w-[35%]">
          <div id="PlaceOrder" class="bg-white rounded-lg p-4">
            ...
            <div class="flex items-center justify-between my-4">
              <div class="font-semibold">Tổng thanh toán</div>
            ...
            <form @submit.prevent="pay()">
              ...
              <button
                ...
                <div v-else>Thanh toán</div>
              </button>
            </form>
          </div>

          <div class="bg-white rounded-lg p-4 mt-4">
            <div class="text-lg font-semibold mb-2 mt-2">Homemap.asia</div>
            <p class="my-2">Homemap keeps your information and payment safe</p>
          </div>
        </div>
      </div>
    </div>
