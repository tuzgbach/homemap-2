  ...
  <MainLayout>
    <div id="AddressPage" class="mt-4 max-w-[500px] mx-auto px-2">
      <div class="mx-auto bg-white rounded-lg p-3">
        <div class="text-xl text-bold mb-2">Địa chỉ giao hàng đến</div>
        <div style="font-size: smaller; margin-bottom: 5px">
          Giao hàng 2h trong nội thành TPHCM
        </div>
        <form @submit.prevent="submit()">
          ...
          <button
            ...
            <div v-if="!isWorking">Cập nhật địa chỉ</div>
            <Icon v-else name="eos-icons:loading" size="20" class="mr-2" />
          </button>
        </form>
      </div>
    </div>
