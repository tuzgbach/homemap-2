  ...
  <div id="MainLayout" class="w-full fixed z-50">
      ...
      <ul
        ...
        <li
          ...
          <div
            ...
            <div v-if="!user" style="font-size: 12px">
              <div
                class="text-semibold my-4 px-3"
                style="font-size: 14px; font-weight: 500">
                Welcome to Homemap!
              </div>
              <div class="flex flex-col items-center gap-3 px-3 mb-3">
                <NuxtLink
                  to="/auth"
                  class="bg-[#FF4646] text-center w-full rounded-sm text-white font-semibold p-2"
    ...
    <div id="MainHeader" class="flex items-center w-full bg-white">
      <div
        ...
        <NuxtLink to="/" class="min-w-[110px]">
          <img width="110" src="/Homemap.svg" />
        </NuxtLink>

        <div class="max-w-[700px] w-full md:block hidden">
          <div class="relative">
            <div
              class="flex items-center border-2 border-[#fe021f] rounded-md w-full">
              <input
              ...
              <button
                ...
                <Icon name="ph:magnifying-glass" size="17" color="#ffffff" />
              </button>
            </div>
